...
public abstract class AbstructClassA {
	...
	// Abstraction means in-complete class, hiding the implementation and showing
	// functionality
	...
	// If inside the class one abstract method is present, then class automatically will
	// be abstract class
	// abstract class finish within 2nd class or sub class or another class
	// abstract class can inherit by using extends key word 

	// Two, Interface -> Interface can contain only abstract method or 100% abstract
	// method
